...
plt.ylabel('standard deviation, nm')
plt.title('standard deviation vs number of sampling interferogram')
plt.legend(loc='upper right')
plt.xlim(2, 200)
plt.tight_layout()
plt.savefig('Images/standard deviation vs number of sampling interferogram', bbox_inches='tight')
plt.show(block=1)
